class ErrorCodes:
    ...
    def _load_messages(cls):
        cls.MESSAGES = {
            ...
            103: "Перейменуйте config.example на config.json та заповніть параметри",
            104: "Помилка перевірки файлу конфігурації",
            105: "Помилка завантаження JSON з файлу конфігурації",
            106: "Помилка відкриття файлу конфігурації",
            # Routes - file
